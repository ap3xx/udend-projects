...
staging_events_table_create= ("""
    CREATE TABLE IF NOT EXISTS stg_events (
        ...
        artist VARCHAR(255) ENCODE ZSTD,
        auth VARCHAR(255) ENCODE ZSTD,
        firstName VARCHAR(255) ENCODE ZSTD,
        gender VARCHAR(1),
        itemInSession INT,
        lastName VARCHAR(255) ENCODE ZSTD,
        length FLOAT8, 
...
staging_songs_table_create = ("""
     CREATE TABLE IF NOT EXISTS stg_songs (
        num_songs INTEGER,
        artist_id VARCHAR(255) ENCODE ZSTD,
        artist_latitude FLOAT8,
        artist_longitude FLOAT8,
        artist_location VARCHAR(255) ENCODE ZSTD,
        artist_name VARCHAR(255) ENCODE ZSTD,
        song_id VARCHAR(255) ENCODE ZSTD,
...
user_table_create = ("""
    CREATE TABLE dim_users(
        ...
        first_name VARCHAR(255) NOT NULL ENCODE ZSTD,
        last_name VARCHAR(255) NOT NULL ENCODE ZSTD,
        gender VARCHAR(1),
        level VARCHAR(50) ENCODE ZSTD,
        PRIMARY KEY (user_id)
    )
...
song_table_create = ("""
    CREATE TABLE dim_songs(
        song_id VARCHAR(255) NOT NULL ENCODE ZSTD,
        title VARCHAR(255) NOT NULL ENCODE ZSTD,
        artist_id VARCHAR(255) ENCODE ZSTD,
        year INTEGER,
        duration FLOAT8,
        PRIMARY KEY (song_id)
...
artist_table_create = ("""
    CREATE TABLE dim_artists(
        artist_id VARCHAR(255) NOT NULL ENCODE ZSTD,
